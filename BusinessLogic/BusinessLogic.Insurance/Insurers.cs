...
namespace BusinessLogic.Insurance
{
    ...
    public class Insurers
    {
        ...
        /// The <c>IReadOnlyRepository</c> to use for retrieving <c>Account</c> records 
        /// from the repository </param>
        /// <param name="insurerRepository">
        /// The <c>IRepository</c> to use for adding, deleting, and updating 
        /// <c>Account</c> records in the  repository
        /// </param>
        /// <param name="logger">
